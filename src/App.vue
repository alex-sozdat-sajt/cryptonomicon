...
export default {
  ...
  methods: {
    subscribeToUpdates(tickerName) {
      setInterval(async () => {
        const f = await fetch(
          `https://min-api.cryptocompare.com/data/price?fsym=${tickerName}&tsyms=USD&api_key=7310e32e5cce03db8aa2a8f947ef99f69844cf38cc168835c16aff4964c17d12`
        );
    ...
    add() {
      ...
      if (ind !== -1) {
        ...
        //!!!!!!!! делал без JSON.stringify - не работает!!!!!!!!
